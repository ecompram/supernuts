...
public class DatePicker extends DialogFragment
    ...
    private static String isFuture;
    ...
    public static class Builder {
         ...
         */
        public Builder future(boolean future, String Type) {
    ...
    private void onDone() {
        ...
        Date d = mDateItem.getCalendar().getTime();
        mCallBack.onDateSet(mBuilder.id, mDateItem.getCalendar(),
                mDateItem.getDay(), mDateItem.getMonth(), mDateItem.getYear(), getDayName(), getMonthName());
        dismiss();
    }
    ...
    public void updateDisplay() {
        try {
            mYear.setText(FormatHelper.toPersianNumber(String.valueOf(mDateItem.getYear())));
            mDate.setText(FormatHelper.toPersianNumber(String.format(Locale.US, "%s ، %d %s",
