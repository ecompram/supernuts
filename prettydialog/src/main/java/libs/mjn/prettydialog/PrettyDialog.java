...
public class PrettyDialog extends AppCompatDialog {
    ...
    public PrettyDialog setTitle(String text){
        ...
        if(!text.contains("گزارشات") && !text.contains("تماس")&&!text.contains("."))
            tv_title.setPadding(0, 170, 0, 0);
        return this;
    }
    ...
    public PrettyDialog setTitleColor(Integer color){
        ...
        tv_title.setTextColor(Color.parseColor("#048b7e"));
        return this;
    }
    ...
    public PrettyDialog setImage(Context cn , String url){
        ...
        findViewById(R.id.iv_img).setVisibility(View.VISIBLE);
        iv_icon.setVisibility(View.GONE);
        imageLoader.displayImage(url, (CircleImageView)findViewById(R.id.iv_img), options);
        return this;
    }
