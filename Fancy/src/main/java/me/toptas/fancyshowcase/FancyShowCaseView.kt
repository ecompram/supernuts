...
class FancyShowCaseView : FrameLayout, ViewTreeObserver.OnGlobalLayoutListener {
        ...
        inflateCustomView(R.layout.fancy_showcase_view_layout_title, object : OnViewInflateListener {
            override fun onViewInflated(view: View) {
                ...
                if (mTitleSize != -1) {
                    ...
                    val typeface = Typeface.createFromAsset(getContext().assets, "font/IRANSansMedium.ttf")
    ...
    class Builder(private val activity: Activity) {
        ...
        fun build(): FancyShowCaseView {
            return FancyShowCaseView(activity, focusedView, mId, mTitle, mSpannedTitle, mTitleGravity, mTitleSize, mTitleSizeUnit,
